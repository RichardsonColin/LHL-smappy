...
exports.seed = function(knex, Promise) {
  ...
  return knex('markers').insert([
    ...
    {lat: 48.4352, long: -123.3654, title: 'I once saw a cat here', description: 'It was black', user_id: 1, map_id: 3},
    {lat: 48.4279, long: -123.3617, title: 'I once saw a dog here', description: 'I petted it for hours', user_id: 1, map_id: 3},
